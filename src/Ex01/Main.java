        ...
        while (true) {
            ...
            switch (line) {
                case "1": {
                    ...
                    switch (type) {
                        case "a": {
                            ...
                            officeManagement.addOfficer(engineer);
                        ...
                        case "b": {
                            ...
                            officeManagement.addOfficer(worker);
                        ...
                        case "c": {
                            ...
                            officeManagement.addOfficer(staff);
                ...
                case "2": {
                    ...
                    String name = scanner.nextLine();
                    officeManagement.getOfficerListByName(name).forEach(officer -> {
                        System.out.println(officer.toString());
                    });
                    break;
                }
                case "3": {
                    officeManagement.printOfficers();
                    break;
                }
                case "4": {
                    return;
